...
<Col lg={3}className=" titles-footer" >
<h6>Endereço</h6>
<p>Av. Brg. Faria Lima, 1485 - Pinheiros, São Paulo - SP, 01451-001, Brasil</p>
</Col>
</Row>
<Row className="m-0 lenguage-row border-test">
{/* 
  <div class="radio-item">
<input type="radio" id="portugues" name="lenguage" value="portugues"/>
  <label className="radio-input" for="Português">Português</label>
  </div> */}
 <Form.Check
